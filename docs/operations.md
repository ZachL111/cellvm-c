...
`cellvm-c` is centered on interpreters work in C. The technical target is: Evaluate spreadsheet-style expressions with dependency diagnostics.
...
The score is deterministic. The current threshold is 159. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 2.
