"""Regression checks for the cellvm-c casebook."""
...
from casebook.harness import assert_expected, cellvm_c_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cellvm_c_summary(), assert_expected())
